CREATE DATABASE  IF NOT EXISTS `cafecuseconnect` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cafecuseconnect`;
-- MySQL dump 10.13  Distrib 8.0.34, for macos13 (arm64)
--
-- Host: localhost    Database: cafecuseconnect
-- ------------------------------------------------------
...
CREATE TABLE `cafe` (
  ...
  `cafeLat` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cafeLong` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`cafeID`)
...
INSERT INTO `cafe` VALUES (0,'Student',NULL,NULL),(101,'Olstein',NULL,NULL),(102,'Pages',NULL,NULL),(103,'Halal Shack',NULL,NULL),(104,'Dunkin',NULL,NULL),(105,'Core',NULL,NULL),(106,'Pandas',NULL,NULL),(107,'Eggers',NULL,NULL),(108,'NVRC',NULL,NULL),(109,'Life Sciences',NULL,NULL),(110,'Schine Pizza',NULL,NULL),(111,'Falk',NULL,NULL),(112,'NewHouse',NULL,NULL),(113,'General',NULL,NULL);
...
INSERT INTO `schedule` VALUES (1,301,1234,101,1,NULL),(2,306,1234,101,1,'Shift Assigned'),(3,312,1234,101,1,NULL),(4,302,4567,101,1,NULL),(5,307,4567,101,1,NULL),(6,304,6348,101,1,NULL),(7,312,6348,101,0,'Already taken'),(8,316,4567,101,1,'Shift Assigned');
...
INSERT INTO `stu_cafe_group` VALUES (0,1234,101,1),(1,4567,101,1),(2,6348,101,0);
...
INSERT INTO `subBook` VALUES (1,1,'2024-04-29',4567,1234,1,101,4,NULL),(2,1,'2024-05-02',4567,6348,1,101,8,NULL),(3,1,'2024-04-30',1234,4567,1,101,2,NULL),(4,1,'2024-04-29',6348,1234,1,101,6,NULL),(5,1,'2024-04-29',6348,4567,0,101,6,'Already Taken');
...
INSERT INTO `user` VALUES (1043,'dikshita@gmail.com,','diskhita','patel','823','3158865396',3,103,_binary 'dsfsdc'),(1234,'rohan@gmail.com,','rohan','bhowmick','123','3158865393',3,101,_binary 'dsfsdc'),(4567,'meeti@gmail.com,','meeti','shah','234','3158865391',3,101,_binary 'dsfsdc'),(4903,'olsteinsup@gmail.com,','olstein','supervisor','502','3158865395',2,101,_binary 'dsfsdc'),(6348,'jaynam@gmail.com,','jaynam','sanghavi','975','3158865392',3,101,_binary 'dsfsdc'),(8011,'kavish@gmail.com,','kavish','shah','5620','3158865398',3,105,_binary 'dsfsdc'),(9023,'niddhi@gmail.com,','niddhi','chauhan','42378','3158865397',3,104,_binary 'dsfsdc'),(9345,'deena@gmail.com,','deena','capria','532','3158865394',1,NULL,_binary 'dsfsdc');
...
-- Dump completed on 2024-04-15 19:50:49
